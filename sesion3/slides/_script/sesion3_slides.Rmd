...
- La función `group_by()` también funciona con `mutate()` para crear una variable resumen:
...
- La función `bind_rows()` permite combinar dos conjuntos de filas en un único objeto. La combinación se lelva  acabo a partir del nombre de las columnas o variables:
